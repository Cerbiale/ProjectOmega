local TweenService = game:GetService("TweenService") 
 ...
 Discord_1.Position = UDim2.new(0.67, 0,0.5, 0) 
 ...
 DiscordInfo_1.Text = "We have a small Discord server. Feel free to join and enjoy your stay!" 
 DiscordInfo_1.TextColor3 = Color3.fromRGB(255,255,255) 
 DiscordInfo_1.TextSize = 12
 ...
 YouTube_1.Position = UDim2.new(0.273, 63,0.499000013, 0) 
 ...
 if Player.UserId ~= 1 or Player.UserId ~= 4097869497 then
         wait(2) 
