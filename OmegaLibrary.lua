...
function Library:CreateWindow(GameName)
	...
	TitleTxt_1.TextColor3 = Color3.fromRGB(100, 180, 251)
	...
	ToggleGUI_1.Text = "Ω"
	ToggleGUI_1.TextColor3 = Color3.fromRGB(100, 180, 251)
	...
	function Library:CreatePopup(Title, Text)
		...
		PopupTitle_1.TextColor3 = Color3.fromRGB(100, 180, 251)
	...
	function Tabs:CreateTab(ImageID)
		...
		local targetTabColorOff = Color3.fromRGB(100, 180, 251)
		...
		TabBtn_1.ImageColor3 = Color3.fromRGB(100, 180, 251)
		...
		function Elements:CreateButton(ButName, Callback)
			...
			ButtonBtn_1.TextColor3 = Color3.fromRGB(100, 180, 251)
		...
		function Elements:CreateToggle(TogName, Callback)
			...
			local targetToggleColorOn = Color3.fromRGB(100, 180, 251)
			...
			ToggleBtn_1.TextColor3 = Color3.fromRGB(100, 180, 251)
		...
		function Elements:CreateBox(BoxName, Callback)
			...
			ButtonBtn_2.TextColor3 = Color3.fromRGB(100, 180, 251)
			...
			BoxHolder_2.BackgroundColor3 = Color3.fromRGB(100, 180, 251)
