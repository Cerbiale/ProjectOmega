...
HomeTab:CreateLabel("Get Lucky Blocks")
HomeTab:CreateButton("Super Block",function()
	game.ReplicatedStorage.SpawnSuperBlock:FireServer()
end)
HomeTab:CreateButton("Diamond Block",function()
	game.ReplicatedStorage.SpawnDiamondBlock:FireServer()
end)
HomeTab:CreateButton("Rainbow Block",function()
	game.ReplicatedStorage.SpawnRainbowBlock:FireServer()
end)
HomeTab:CreateButton("Galaxy Block",function()
	game.ReplicatedStorage.SpawnGalaxyBlock:FireServer()
end)
HomeTab:CreateButton("Void Block",function()
